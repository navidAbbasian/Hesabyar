...
class Controller extends ApiController
{
    ...
    public function findProductById(FindProductByIdRequest $request): array
    {
        ...
        return $this->transform($product, (new ProductTransformer())->setDefaultIncludes(['productCategory', 'unit']));
    }
    ...
    public function getAllProducts(GetAllProductsRequest $request): array
    {
        ...
        return $this->transform($products, ( new ProductTransformer())->setDefaultIncludes(['productCategory', 'unit']));
    }
